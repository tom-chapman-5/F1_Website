...
function displayDriver(driverName) {
	fetch("https://raw.githubusercontent.com/tom-chapman-5/driver_data/refs/heads/main/Aston_drivers.json")
		.then(response => {
			if (!response.ok) {
		...
		.then(data => {
			...
			if (driver) {
				...
				driverCard.innerHTML = `
					...
					<h3>Stats with Aston Martin</h3>
					<p>Seasons: ${driver.seasons_aston}</p>
					<p>Wins: ${driver.wins_aston}</p>
					<p>Poles: ${driver.poles_aston}</p>
					<p>Races: ${driver.races_aston}</p>
...
function displayStats() {
	...
	driverCard.innerHTML = `
		...
		<ul>
			...
			<li style="float: none;">Podiums: 9</li>
			<li style="float: none;">Poles: 0</li>
			<li style="float: none;">Races: 102</li>
		</ul>
		<h2>2025 Stats</h2>
		<ul>
			<li style="float: none;">Race Wins: 0</li>
			...
			<li style="float: none;">Points: 14</li>
