...
function displayDriver(driverName) {
	fetch("https://raw.githubusercontent.com/tom-chapman-5/driver_data/refs/heads/main/Williams_drivers.json")
		.then(response => {
			if (!response.ok) {
		...
		.then(data => {
			...
			if (driver) {
				...
				driverCard.innerHTML = `
					...
					<h3>Stats with Williams</h3>
					<p>Seasons: ${driver.seasons_williams}</p>
					<p>Wins: ${driver.wins_williams}</p>
					<p>Poles: ${driver.poles_williams}</p>
					<p>Races: ${driver.races_williams}</p>
...
function displayStats() {
	...
	driverCard.innerHTML = `
		<h2>Stats</h2>
		<ul>
			<li style="float: none;">WDC: 7</li>
			<li style="float: none;">WCC: 9</li>
			<li style="float: none;">Race Wins: 114</li>
			<li style="float: none;">Podiums: 313</li>
			<li style="float: none;">Poles: 128</li>
			<li style="float: none;">Races: 862</li>
		</ul>
		<h2>2025 Stats</h2>
		<ul>
			<li style="float: none;">Race Wins: 0</li>
			<li style="float: none;">Poles: 0</li>
			<li style="float: none;">Strint Wins: 0</li>
			<li style="float: none;">Points: 25</li>
