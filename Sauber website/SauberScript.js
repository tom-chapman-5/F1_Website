...
function displayDriver(driverName) {
	fetch("https://raw.githubusercontent.com/tom-chapman-5/driver_data/refs/heads/main/Sauber_drivers.json")
		.then(response => {
			if (!response.ok) {
		...
		.then(data => {
			...
			if (driver) {
				...
				driverCard.innerHTML = `
					...
					<h3>Stats with Sauber</h3>
					<p>Seasons: ${driver.seasons_sauber}</p>
					<p>Wins: ${driver.wins_sauber}</p>
					<p>Poles: ${driver.poles_sauber}</p>
					<p>Races: ${driver.races_sauber}</p>
...
function displayStats() {
	...
	driverCard.innerHTML = `
		...
		<ul>
			...
			<li style="float: none;">Podiums: 27</li>
			<li style="float: none;">Poles: 1</li>
			<li style="float: none;">Races: 495</li>
		</ul>
		<h2>2025 Stats</h2>
		<ul>
			...
			<li style="float: none;">Points: 6</li>
